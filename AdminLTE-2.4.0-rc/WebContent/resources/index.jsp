						...
						<li class="dropdown user user-menu"><a href="#"
							...
							<ul class="dropdown-menu">
								...
								<li class="user-header"><img
									...
									<p>
										<%= request.getParameter("email") %> <small>Member since
											Nov. 2012</small>
									</p></li>
								<!-- Menu Body -->
								<li class="user-body">
			...
			<section class="sidebar">
				...
				<div class="user-panel">
					...
					<div class="pull-left info">
						<p><%= request.getParameter("email") %><%= request.getParameter("pw") %></p>
				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					<li class="treeview"><a href="#"> <i class="fa fa-folder"></i>
						...
						<ul class="treeview-menu">
							<li><a href="pages/examples/blank6.html"><i
									class="fa fa-circle-o"></i> 동아 일보 게시판</a></li>
							<li><a href="pages/examples/blank4.html"><i
									class="fa fa-circle-o"></i> 일반 게시판</a></li>
							<li><a href="pages/examples/blank3.html"><i
									class="fa fa-circle-o"></i> 휴게소별 날씨 정보</a></li>
							<li><a href="pages/examples/blank2.html"><i
				...
				<div id="visual">
					<div id="mySwipe" class='swipe'>
						<ul class="touch_banner swipe-wrap">
							<!-- 배너 목록 -->
							<li><a href="#"><img src="./images/visual_img_1.jpg" max-height:"100%"
									alt="" /></a></li>
							<li><a href="#"><img src="./images/visual_img_2.jpg" max-height:"100%"
									alt="" /></a></li>
							<li><a href="#"><img src="./images/visual_img_3.jpg" max-height:"100%"
									alt="" /></a></li>
						</ul>
					</div>
