				...
				<div id="visual">
					<div id="mySwipe" class='swipe'>
						<ul class="touch_banner swipe-wrap">
							<!-- 배너 목록 -->
							<li><a href="#"><img src="<%=  request.getContextPath() %>/resources/images/visual_img_1.jpg" 
									alt="" /></a></li>
							<li><a href="#"><img src="<%=  request.getContextPath() %>/resources/images/visual_img_2.jpg" 
									alt="" /></a></li>
							<li><a href="#"><img src="<%=  request.getContextPath() %>/resources/images/visual_img_3.jpg" 
									alt="" /></a></li>
						</ul>
					</div>
					<ul class="touch_bullet">
						<!-- 배너 위치 표시 -->
						<li><img src="<%=  request.getContextPath() %>/resources/images/visual_bullet_on.png" class="active"
							alt="" /></li>
						<li><img src="<%=  request.getContextPath() %>/resources/images/visual_bullet_off.png" alt="" /></li>
						<li><img src="<%=  request.getContextPath() %>/resources/images/visual_bullet_off.png" alt="" /></li>
					</ul>
					<p class="touch_left_btn">
						<!-- 이전 버튼 -->
						<a href="#"> <img src="<%=  request.getContextPath() %>/resources/images/visual_btn_left.png" alt="이전 배너" />
						</a>
					</p>
					<p class="touch_right_btn">
						<!-- 이전 버튼 -->
						<a href="#"> <img src="<%=  request.getContextPath() %>/resources/images/visual_btn_right.png"
							alt="다음 배너" />
						</a>
					</p>
				</div>
